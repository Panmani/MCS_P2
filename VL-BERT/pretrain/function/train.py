...
def train_net(args, config):
    ...
    if args.dist:
        ...
        if isinstance(config.DATASET, list):
            import pickle
            with open('tmp_config.pk', 'wb') as f:
            ...
            val_loader = MultiTaskDataLoader(val_loaders)
            print('LOADER SIZE: {} {}'.format(len(train_loader), len(val_loader)))
    ...
    # import pickle
    # with open('tmp_loader.pk', 'wb') as f:
    #     pickle.dump(train_loader, f)
    #     print('break point dumped successfully.')
