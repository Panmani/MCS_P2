...
DATASET_CATALOGS = {'conceptual_captions': ConceptualCaptionsDataset,
                    ...
                    'vc_temporal_captions': VCTemporalCaptionsDataset,
                    'cc_temporal_captions': COCOTemporalCaptionsDataset}
...
def make_dataloader(cfg, dataset=None, mode='train', distributed=False, num_replicas=None, rank=None,
    ...
    if dataset is None:
        ...
        print('DATASET:{} SIZE:{} BATCH_SIZE:{}'.format(cfg.DATASET.DATASET, len(dataset), batch_size))
